...
router
  .route("/")
  .post(verifyJWT, verifyAdmin, upload.array("images", 8), validate(createProductSchema), createProduct);
router
  .route("/:id")
...
router
  .route("/:id/images")
  .post(verifyJWT, verifyAdmin, upload.array("images", 8), validate(idParamSchema), uploadImages);
